    ...
    >
      <div className="max-w-6xl mx-auto px-10 pt-16 pb-20">
        <div className="grid md:grid-cols-2 gap-16 items-start mb-14">
          <h2 className="font-heading" style={{ color: INK, fontSize: "clamp(2.2rem, 4.2vw, 3.8rem)", lineHeight: 1.15, maxWidth: "260px" }}>
            <span className="font-black">Health is shaped by everyday life, </span>
            <span className="font-light">not healthcare alone.</span>
          </h2>
