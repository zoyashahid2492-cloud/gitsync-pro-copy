...
export default function StatsRibbon() {
  return (
    <section className="bg-[#1A2621] py-16 lg:py-20 px-5 lg:px-10">
      <div className="max-w-[1200px] mx-auto">
        <h2 className="text-2xl lg:text-3xl font-bold text-white text-center mb-10 lg:mb-14">Real change, already underway.</h2>
